...
export const ui = {
  en: {
    ...
    of_total: "of",
    clearFilters: "Clear",
    noResults: "No patterns match your search",
  ...
  es: {
    ...
    searchPatterns: "Buscar patrones...",
    allCategories: "Todas las categorías",
    anySeverity: "Cualquier toxicidad",
    showing: "Mostrando",
    of_total: "de",
    clearFilters: "Limpiar",
    noResults: "No hay patrones que coincidan con tu búsqueda",
    tryAdjusting: "Prueba a ajustar los filtros",
  },
} as const;
