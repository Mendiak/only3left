...
export function PatternCard({ pattern, locale = "en" }: PatternCardProps) {
  ...
  return (
    <Link href={localePath(locale, `/patterns/${pattern.slug}`)} className="group flex min-h-64 flex-col justify-between border border-white/10 bg-surface p-5 transition-all duration-300 hover:-translate-y-1 hover:border-accent hover:shadow-xl hover:shadow-accent/5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 focus-visible:ring-offset-ink">
      <div>
